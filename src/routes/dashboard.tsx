...
import { BarChart3, Users, Eye, Sparkles, Calendar, Shield, Upload, FileText, CheckCircle } from 'lucide-react'
...
function DashboardComponent() {
  const { currentUser, profiles, interestedBusinessIds, meetings, uploadVerificationDocs, approveVerification, rejectVerification } = useStore()
